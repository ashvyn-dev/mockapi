...
from .serializers import (CollectionSerializer, EndpointResponseSerializer,
                          ...
                          UserSerializer)
from .openapi_utils import generate_openapi_schema, import_openapi_schema, validate_openapi_schema
    ...
    def openapi_schema(self, request, slug=None):
        ...
        try:
            ...
            if format_type == "json":
                ...
                response["Content-Disposition"] = f'attachment; filename="{collection.slug}-openapi.yaml"'
                return response
